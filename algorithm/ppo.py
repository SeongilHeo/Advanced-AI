...
class PPO(Algorithm):
    ...
    def _compute_loss_pi(self, data):
        ...
        clipfrac = torch.as_tensor(clipped, dtype=torch.float32, device=self.device).mean().item()
    ...
    def _update(self):
        ...
        kl, ent, cf = pi_info_new['kl'], pi_info_new['ent'], pi_info_new['cf']
        ...
        self.train_returns['clip_frac'].append(cf)
